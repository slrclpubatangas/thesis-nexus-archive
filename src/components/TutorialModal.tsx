...
const TutorialModal: React.FC<TutorialModalProps> = ({ isOpen, onClose }) => {
  ...
  const embedUrl = "https://www.youtube.com/embed/iW7SPbqVZZg?si=voPM4WZnx4hMaEP4";
  const directUrl = "https://www.youtube.com/watch?v=iW7SPbqVZZg";
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl w-full h-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Learn how to use the UndergradFile system with this step-by-step tutorial.
          </DialogDescription>
        </DialogHeader>
