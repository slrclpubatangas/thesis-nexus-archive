...
const CSVUploadSection: React.FC<CSVUploadSectionProps> = ({
  ...
  const downloadTemplate = () => {
    ...
    const sampleData = [
      ...
      ['THS-2024-002', 'Sustainable Architecture in Urban Development', 'Jane Smith', 'Architecture', '2023'],
      ['THS-2024-003', 'Quantum Computing Applications in Cryptography', 'Alice Johnson', 'Physics', '2024'],
      ['THS-2024-004', 'Impact of Social Media on Mental Health', 'Bob Williams', 'Psychology', '2023'],
      ['THS-2024-005', 'Renewable Energy Solutions for Rural Communities', 'Sarah Davis', 'Engineering', '2024']
    ];
