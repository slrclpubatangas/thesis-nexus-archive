    ...
    <div className="space-y-6 w-full">
      ...
      <div className="space-y-4 min-w-full">
        ...
        <div className="flex flex-col md:flex-row gap-2 w-full">
          <div className="flex items-center space-x-2 w-full md:w-[220px] flex-shrink-0">
      ...
      {(searchTerm || filterType !== 'all' || campusFilter !== 'all' || dateFilter || dateRange.start || dateRange.end) && (
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 bg-blue-50 border border-blue-200 rounded-lg px-4 py-3">
          <div className="flex items-center space-x-2 text-sm text-blue-800 flex-1">
            <Search size={16} />
            <span>
       ...
       <div className="card-hover overflow-hidden">
        <div className="overflow-x-auto">
          ...
          <div className="sticky top-0 z-10 bg-gray-50 flex px-6 py-3 border-b gap-x-4">
            <div className="flex-1 min-w-[160px] text-left text-xs font-medium text-gray-500 uppercase">Name</div>
            <div className="flex-1 min-w-[140px] text-left text-xs font-medium text-gray-500 uppercase">Type</div>
            <div className="flex-1 min-w-[150px] text-left text-xs font-medium text-gray-500 uppercase">ID/School</div>
            <div className="flex-1 min-w-[140px] text-left text-xs font-medium text-gray-500 uppercase">Campus</div>
            <div className="flex-1 min-w-[180px] text-left text-xs font-medium text-gray-500 uppercase">Program</div>
            <div className="flex-[2] min-w-[200px] text-left text-xs font-medium text-gray-500 uppercase">Thesis Title</div>
            <div className="flex-1 min-w-[130px] text-left text-xs font-medium text-gray-500 uppercase">Time Created</div>
            <div className="flex-1 min-w-[120px] text-left text-xs font-medium text-gray-500 uppercase">Date</div>
            {userRole === 'Admin' && (
              <div className="w-24 flex-shrink-0 text-left text-xs font-medium text-gray-500 uppercase">Actions</div>
            )}
          </div>
            ...
            <div className="overflow-y-auto max-h-[500px]">
              <AnimatePresence>
                {filteredAndSortedRecords.map(record => (
                  ...
                  >
                    <div className="flex-1 min-w-[160px] text-sm font-medium text-gray-900 truncate">
                      {record.full_name}
                    </div>
                    ...
                    <div className="flex-1 min-w-[150px] text-sm text-gray-900 truncate">
                      {record.student_number || record.school || '-'}
                    </div>
                    <div className="flex-1 min-w-[140px] text-sm text-gray-900 truncate">
                      {record.campus}
                    </div>
                    <div className="flex-1 min-w-[180px] text-sm text-gray-900 truncate">
                      {record.program || '-'}
                    </div>
                    <div
                      className="flex-[2] min-w-[200px] text-sm text-gray-900 truncate"
                      title={record.thesis_title}
                    >
                      {record.thesis_title}
                    </div>
                    <div className="flex-1 min-w-[130px] text-sm text-gray-900">
                      {new Date(record.created_at).toLocaleTimeString('en-US', {
                        hour: '2-digit',
                        minute: '2-digit',
                        hour12: true,
                    ...
                    <div className="flex-1 min-w-[120px] text-sm text-gray-900">
                      {new Date(record.submission_date).toLocaleDateString()}
                    </div>
                    {userRole === 'Admin' && (
                      <div className="w-24 flex-shrink-0 flex space-x-2">
                        <button
