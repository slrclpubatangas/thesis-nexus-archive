  ...
  <div>
    ...
    <div className="relative">
      <input
        ...
        className="w-full pr-12 py-2 border rounded-lg focus:ring-red-500 focus:border-red-500 [&::-ms-reveal]:hidden [&::-ms-clear]:hidden [&::-webkit-credentials-auto-fill-button]:hidden [&::-webkit-contacts-auto-fill-button]:hidden"
        required
      />
      <button
        type="button"
